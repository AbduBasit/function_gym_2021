                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" max="100" name="commison" placeholder="10%" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="tfile" class="custom-file-input" id="customer-img">
