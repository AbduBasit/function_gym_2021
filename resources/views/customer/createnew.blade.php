                                ...
                                <div class="row pl-2 pr-2">
                                    ...
                                    <div class="col-lg-3 mb-2 display">
                                        <div class="form-group">
                                            ...
                                            <select name="tname" id="single-select" class="form-control new-lg form-control-lg" required>
                                    ...
                                    <div class="col-lg-3 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="gymfee" class="form-control" id="g-fees" placeholder="5000" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 mb-2 display">
                                        <div class="form-group">
                                            <label class="text-label">Trainer Fee Per Session*</label>
                                            <input type="text" name="trainfee" class="form-control" placeholder="2000">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 mb-2 display">
                                        <div class="form-group">
