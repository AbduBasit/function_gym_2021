        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn-group">
                        <a class="btn btn-outline-dark btn-md" href="{{url('customer-edit/'.$datas->id)}}" role="button"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Basic Information </a>
                        @if ($datas->training_type == "PT")
                        <a class="btn btn-outline-dark btn-md" href="{{url('customer-edit-pt/'.$datas->id)}}" role="button"><i class="fa fa-pencil" aria-hidden="true"></i> Edit PT Information</a>     
                        @endif
                    </div>
                </div>
                <div class="card-body">
                        <div id="full_details">
                            ...
                            <div id="accordion-four" class="accordion mt-3 accordion-bordered">
                                @if ($datas->training_type == "PT")
                                <div class="accordion__item">
                                    <div class="accordion__header collapsed" data-toggle="collapse" data-target="#bordered_no-gutter_collapseTwo" aria-expanded="false">
                                        <span class="accordion__header--text"><h4>Assesment</h4></span>
                                        <span class="accordion__header--indicator style_two"></span>
                                    </div>
                                    <div id="bordered_no-gutter_collapseTwo" class="accordion__body collapse" data-parent="#accordion-four" style="">
                                ...
                                <div class="accordion__item">
                                    <div class="accordion__header collapsed" data-toggle="collapse" data-target="#bordered_no-gutter_collapseThree" aria-expanded="false">
                                        <span class="accordion__header--text"><h4>Account </h4></span>
                                        <span class="accordion__header--indicator style_two"></span>
                                    </div>
                                    <div id="bordered_no-gutter_collapseThree" class="accordion__body collapse" data-parent="#accordion-four" style="">
                                        <div class="accordion__body--text">
                                            <section>
                                                <div class="row ">
                                                    <div class="col-lg-6 mb-2">
                                    ...
                                    @if ($datas->training_type == "PT")
                                    <div class="accordion__item">
                                        <div class="accordion__header collapsed" data-toggle="collapse" data-target="#bordered_no-gutter_collapseOne" aria-expanded="false">
                                            <span class="accordion__header--text"><h4>Gym Schedule</h4></span>
                                            <span class="accordion__header--indicator style_two"></span>
                                        </div>
                                        <div id="bordered_no-gutter_collapseOne" class="accordion__body collapse" data-parent="#accordion-four" style="">
                                            <div class="accordion__body--text">
                                                <section class="">
                                                    <div class="row">
